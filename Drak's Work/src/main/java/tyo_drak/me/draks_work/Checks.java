...
public class Checks {
    ...
    public static boolean isHostileMadeOfFlesh(EntityType entityType) {
        return entityType.equals(EntityType.HUSK) ||
                ...
                /* 1.16.2 entityType.equals(EntityType.PIGLIN_BRUTE) || */
    ...
    /*
    public static boolean isForGatunosInteract(Material material){
        return ;
    }

    public static boolean isForGatunosPlace(Material material){
        return ;
    }

    public static boolean isForCacadoresInteract(Material material){
        return ;
    }

    public static boolean isForCacadoresPlace(Material material){
        return ;
    }

    public static boolean isForEspadachinsInteract(Material material){
        return ;
    }

    public static boolean isForEspadachinsPlace(Material material){
        return ;
    }
    */
    ...
    public static boolean isLavable(Material type) {
        return isWebbable(type) ||
